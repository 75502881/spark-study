...
public class TransformationJoin {
	...
	private static void filter() {
		...
		List<Tuple2< Integer,String>> nameList = Arrays.asList(new Tuple2< Integer,String>(1,"class1"),
				...
				new Tuple2< Integer,String>( 4,"class4"),
				new Tuple2< Integer,String>( 8,"class8"));

		List<Tuple2< Integer,Integer>> scoresList = Arrays.asList(new Tuple2< Integer,Integer>(1,10),
				new Tuple2< Integer,Integer>(9,99),
				new Tuple2< Integer,Integer>(1,30),
				new Tuple2< Integer,Integer>(2,55), new Tuple2< Integer,Integer>(3,34),
		...
		JavaPairRDD< Integer,Tuple2< String,Integer>> studentListRdd  =nameListRdd.join(scoresListRdd).sortByKey();
		
		studentListRdd.foreach(new VoidFunction<Tuple2<Integer,Tuple2<String,Integer>>>() {
